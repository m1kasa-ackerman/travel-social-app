...
public class SavedPlaceService {
    ...
    public List<SavedPlaceResponse> listSavedPlaces(User user) {
        return savedPlaceRepository.findByUserIdOrderBySavedAtDesc(user.getId().toString())
    ...
    public SavedPlaceResponse savePlace(User user, SavePlaceRequest req) {
        ...
        savedPlaceRepository.findByUserIdOrderBySavedAtDesc(user.getId().toString())
                .stream()
    ...
    public void deletePlace(User user, String id) {
        savedPlaceRepository.deleteByUserIdAndId(user.getId().toString(), id);
    }
